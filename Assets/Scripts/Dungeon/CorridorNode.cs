...
namespace Dungeon
{
 ...
 private Node structure1;
    ...
    private void ProcessRoomInRelationUpOrDown(Node structure1, Node structure2)
    {
        ...
        List<Node> structureBottmChildren = StructureHelper.TraverseGraphToExtractLowestLeaf(structure1);
        Node topStructure = null;
        List<Node> structureAboveChildren = StructureHelper.TraverseGraphToExtractLowestLeaf(structure2);
